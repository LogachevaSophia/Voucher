                                            ...
                                            <div style="margin-left:95px ">
                                                ...
                                                ?>
                                                    <form method="post" action="">
                                                        ...
                                                        <input style="font-size:10px;  margin-top:3px" placeholder="Логин" name='login'></input>
                                                        <br>
                                                        <label for='pass'>Пароль</label>
                                                        <input style="font-size:10px" placeholder="Пароль" name='pass'></input>
                                                        <br>
                                                        <input class='back' style="font-size:10px; margin-top:5px" type='submit' value="Войти" name='done'></input>
                                                    </form>
                                                <?php
                                                }
                                                ?>
